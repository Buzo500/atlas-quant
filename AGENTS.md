...
- La secuencia vigente de versiones está en `docs/hoja_de_ruta.md`. Las mejoras operativas de v0.2 están en desarrollo: leer `docs/plan_v0_2.md`, `docs/auditoria_v0_2.md` y `docs/operacion_windows.md` al trabajar en ellas. La candidata se identifica como 0.2.0-rc.1; no etiquetarla estable hasta completar CI y el ensayo de 48 horas. Consultar docs/candidata_v0_2.md para el cierre.
