...
% Proposed engine: LuaLaTeX. Compilation has not been validated in this delivery.
...
\newcommand{\AtlasSection}[1]{\vspace{8pt}{\large\bfseries\color{copper}#1}\par}
\begin{document}
...
\begin{tikzpicture}
\begin{axis}[width=\linewidth,height=60mm,axis lines=left,
...
El futuro paquete conservará fuente TeX, JSON, CSV, recursos locales y manifiesto.
La compilación estará aislada, sin red ni shell-escape. Este archivo es una propuesta
de plantilla y su compilación queda pendiente de verificar con la herramienta fijada.
\end{document}
