...
- Arranque habitual inicial correcto: run `b5f753dd544b4b81853ac2d69b487aee`, `0.5.0-dev.2`, esquema 5 e integridad correctos. Tres libros/respuestas EUR e históricos iguales a la copia previa; sin registros analíticos ficticios ni movimientos nuevos, parada global activa y gasto/reserva cero. Evidencia `output/validation/v05-expanded-ordinary-online.json`. Comprobación final de parada/reinicio y publicación pendientes de CI.
