...
## Estado actual: D2 de v0.4 implementado y validado localmente
...
Siguiente decisión: revisar D2 en la interfaz y preparar su PR/CI gratuita antes de integrar. No hay autorización nueva de publicación en este trabajo. D3 requiere concretar su diseño antes de desarrollarlo. El ensayo de 48 horas y su seguimiento siguen aplazados; v0.2 continúa sin etiqueta estable. Los estados inferiores son históricos y no sustituyen este cierre.
