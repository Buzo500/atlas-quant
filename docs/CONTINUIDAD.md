...
ATLAS normal está detenido. La consolidación modifica herramientas, pruebas y documentación; no cambia programa, contratos, dependencias ni build. Preparada para revisión final local; sin nueva subida, CI, fusión ni etiqueta. G6 abierto; ensayo de 48 horas y seguimiento aplazados. No iniciar nuevas funcionalidades por la aceptación de esta revisión.
