...
**Estado de entrega:** G1–G5 implementadas en `0.3.0-dev.1`; G6 recibe una [revisión de los controles actuales](revision_graficos_20260909.md) y la [CI gratuita 34340199451 superada](https://github.com/Buzo500/atlas-quant/actions/runs/34340199451) sobre `c8f4eb6`: 477 pruebas Python y 91 subtests, 244 frontend y 10/10 E2E. Hay nuevas medidas locales de rendimiento. El intento local previo conserva su resultado 9/10 por una espera intermitente de `/api/state`; siguen pendientes su diagnóstico y repetir el escalado físico sobre los controles nuevos. La CI correcta no demuestra resuelta esa causa. Los viewports CSS comprobados no sustituyen Windows 125 %/150 %. La [guía de gráficos](graficos_v0_3.md) registra uso y limitaciones; G6 no se da por cerrado ni se etiqueta estable.
