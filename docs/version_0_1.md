...
Actualización posterior en la rama local `codex/v0.6-evaluador`: [núcleo puro SMA20/50](v0_6_evaluador.md) y [simulador económico EUR offline con referencia CLI](v0_6_simulacion.md) implementados y probados, separados de la interfaz y del Laboratorio legacy. Lotes/costes, siguiente apertura, límites y recuperación; 909 Python + 91 subcasos. No se publica una versión de aplicación v0.6 ni se integra todavía con datasets reales, HTTP o UI.
