...
**Versión actual: `0.4.0-dev.3` · D4, importación y conciliación EUR**, esquema SQLite 3. En Datos, «Libro y conciliación» importa CSV v2 en carteras nuevas, compara efectivo/posiciones con un extracto completo y conserva correcciones e informes por revisión. [Uso, contratos y validación D4](docs/v0_4_d4.md).

**Entrega publicada: [v0.4.0-dev.3](https://github.com/Buzo500/atlas-quant/tree/v0.4.0-dev.3)**, D4 integrado en [PR #6](https://github.com/Buzo500/atlas-quant/pull/6), con [CI gratuita correcta](https://github.com/Buzo500/atlas-quant/actions/runs/34456773938): 570 Python + 91 subtests, 255 frontend y 14 E2E. Incluye las entregas anteriores de identidad y [calidad/revisiones de precios D3](docs/v0_4_d3.md). Sigue siendo una versión de desarrollo.
