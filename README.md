...
**Desarrollo local actual: `0.4.0-dev.3` · D4, importación y conciliación EUR.** Rama `codex/v0.4-d4`, esquema SQLite 3. En Datos, «Libro y conciliación» importa CSV v2 en carteras nuevas, compara efectivo/posiciones con un extracto completo y conserva correcciones e informes por revisión. [Uso, contratos y validación D4](docs/v0_4_d4.md).

**Entrega publicada: [v0.4.0-dev.2](https://github.com/Buzo500/atlas-quant/tree/v0.4.0-dev.2)**, D3 y arquitectura documental integrados en [PR #5](https://github.com/Buzo500/atlas-quant/pull/5), con [CI gratuita correcta](https://github.com/Buzo500/atlas-quant/actions/runs/34376199945): 523 Python + 91 subtests, 249 frontend y 13 E2E. Incluye calidad y revisiones de precios; [reglas D3](docs/v0_4_d3.md). D4 es posterior y su validación local no equivale a una CI remota propia.

Las carteras anteriores conservan `legacy-eur-v1`, sus gráficos y CSV v1. Las nuevas permiten elegir libro exacto `atlas-accounting-v2`: efectivo, cantidades, coste y ventas realizadas en EUR, sin precios; su valoración y rentabilidad se completarán en D6/D7. Ambos libros pueden conciliar extractos EUR. USD sigue **solo en el catálogo**; dividendos/splits nuevos, FX y XIRR corresponden a D5–D8. La evidencia de calidad debe ser declarada y contrastada.
...
Alcance aprobado de [v0.4 · Datos y contabilidad trazables](docs/plan_v0_4.md): ocho entregas, CSV propio y EUR/USD. [D1](docs/v0_4_d1.md) concreta contratos y convenciones; D2/D3 publicados, D4 desarrollado localmente y D5–D8 pendientes.
