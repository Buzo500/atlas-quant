...
**Instalar lo último en otro PC Windows:** [guía del portátil](docs/instalacion_portatil.md). La rama `codex/v0.5-comparador` ya está subida a GitHub; contiene dev.3 y la documentación actual. Todavía no está fusionada en `master` ni tiene CI remota/etiqueta nuevas. Las menciones a «desarrollo local» de abajo describen dónde se validó; código y guía ya están disponibles en esa rama.

**Desarrollo local: v0.5.0-dev.3 · fichas y comparador de activos.** En Datos: precios EUR/USD, cobertura, volatilidad, caída máxima, comparación en base 100 y correlaciones sobre intervalos comunes, con informes inmutables. [Uso y validación](docs/v0_5_comparador.md), [ejemplo de planificación](docs/v0_5_ejemplo_guiado.md), [revisión del cierre v0.5](docs/v0_5_cierre.md) y [contrato inicial v0.6](docs/v0_6_alcance_inicial.md). Rama `codex/v0.5-comparador`, esquema 5; nueva CI/publicación pendientes. V0.6 solo definida, no implementada.
