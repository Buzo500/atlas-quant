...
**Versión actual: `0.4.0-dev.4` · D5, dividendos y splits conciliados**, esquema SQLite 4. En Datos, «Dividendos y splits» registra eventos revisionados, derechos y cobros EUR separados, enlaces sin doble abono y splits exactos con coste conservado. [Uso, contratos y validación D5](docs/v0_4_d5.md).
...
Las carteras anteriores conservan `legacy-eur-v1`, sus gráficos y CSV v1. Las nuevas permiten elegir libro exacto `atlas-accounting-v2`: efectivo, cantidades, coste y ventas realizadas en EUR, sin precios; su valoración y rentabilidad se completarán en D6/D7. Ambos libros pueden conciliar extractos EUR. USD sigue **solo en el catálogo**; FX, valoración y XIRR corresponden a D6/D7. D5 admite dividendos EUR ordinarios (un pago completo por derecho) y splits/reverse splits; fracciones solo acreditadas y representables exactamente. No hay liquidación de fracciones ni fiscalidad automática. La evidencia de calidad debe ser declarada y contrastada.
