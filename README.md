...
**Desarrollo local: `0.4.0-dev.5` · D6.1/D6.2, esquema SQLite 5.** API `/api/v2` con libro EUR/USD, conversiones explícitas, conciliación por moneda y dividendos/splits USD. La interfaz mantiene el recorrido EUR de D5; formularios multidivisa, precios USD/series FX y NAV siguen pendientes. [Uso, compatibilidad y validación local](docs/v0_4_d6_implementacion.md). D5 no abre esquema 5: recuperar copia anterior y fuentes/build compatibles para retroceder.

**Entrega publicada: [v0.4.0-dev.4](https://github.com/Buzo500/atlas-quant/tree/v0.4.0-dev.4)**, D5 integrado en [PR #7](https://github.com/Buzo500/atlas-quant/pull/7), con [CI gratuita correcta](https://github.com/Buzo500/atlas-quant/actions/runs/34479828915): 623 Python + 91 subtests, 266 frontend y 18 E2E, además de instalación, contratos, compilación y arranque/parada. Incluye las entregas anteriores de identidad, [calidad/revisiones de precios D3](docs/v0_4_d3.md) y [libro/conciliación D4](docs/v0_4_d4.md). Sigue siendo una versión de desarrollo.

Las carteras anteriores conservan `legacy-eur-v1`, sus gráficos y CSV v1. Las nuevas permiten elegir libro exacto `atlas-accounting-v2`: efectivo, cantidades, coste y ventas realizadas en EUR, sin precios; su valoración y rentabilidad se completarán en D6/D7. Ambos libros pueden conciliar extractos EUR. D6.2 permite USD y conversiones explícitas por API; series FX, valoración y XIRR siguen pendientes en D6/D7. D5 admite dividendos EUR ordinarios (un pago completo por derecho) y splits/reverse splits; fracciones solo acreditadas y representables exactamente. No hay liquidación de fracciones ni fiscalidad automática. La evidencia de calidad debe ser declarada y contrastada.
...
Alcance aprobado de [v0.4 · Datos y contabilidad trazables](docs/plan_v0_4.md): ocho entregas, CSV propio y EUR/USD. [D1](docs/v0_4_d1.md) concreta contratos y convenciones; D2–D5 publicados. [D6: saldos EUR/USD, FX y valoración](docs/v0_4_d6.md) tiene D6.1/D6.2 implementados localmente; D6.3–D6.6 y D7–D8 pendientes. El estado de validación y publicación se recoge en [continuidad](docs/CONTINUIDAD.md).
