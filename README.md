...
**Desarrollo actual: `0.6.0-dev.2`, rama `codex/v0.6-evaluador`, esquema 5.** El Laboratorio añade [walk-forward con parámetros fijos](docs/v0_6_walk_forward.md): ventanas móviles dentro del desarrollo, calentamiento previo, cuentas independientes, criterios congelados e informe reproducible. Se configura al crear un protocolo; no abre la prueba final. Esta ampliación es local, pendiente de subida/CI remota. Conserva [CSV nativo EUR, historial y benchmarks](docs/v0_6_laboratorio.md); la CI gratuita 34590252591 validó dev.1, no estos cambios. PR #12 mantiene su revisión manual pendiente; no hay nueva etiqueta.
