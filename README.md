...
**Desarrollo: `0.4.0-dev.5` · D6 completo, esquema SQLite 5.** Libro EUR/USD, conversiones, conciliación y eventos; CSV propio de precios/FX versionados, vínculos explícitos y patrimonio EUR por fecha con fuentes y cortes guardados. Formularios multidivisa disponibles. [Uso, compatibilidad y evidencia](docs/v0_4_d6_cierre.md). PR #8 en revisión; publicación y CI definitiva en continuidad. D5 requiere copia anterior y fuentes/build compatibles para retroceder.
...
Alcance aprobado de [v0.4 · Datos y contabilidad trazables](docs/plan_v0_4.md): D1–D8, CSV propio y EUR/USD. D2–D5 publicados; D6 completo en revisión, D7/D8 autorizados para continuar. El estado de validación y publicación se recoge en [continuidad](docs/CONTINUIDAD.md).
